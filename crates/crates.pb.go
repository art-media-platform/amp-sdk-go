...
func (AssetFlags) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_44b18017c076fca5, []int{0}
}
...
func (CrateSchema) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_44b18017c076fca5, []int{1}
}
...
func (*AssetEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_44b18017c076fca5, []int{2}
}
...
func (*BundleManifest) Descriptor() ([]byte, []int) {
	return fileDescriptor_44b18017c076fca5, []int{3}
}
...
func (*CrateInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_44b18017c076fca5, []int{4}
}
...
func (*CrateManifest) Descriptor() ([]byte, []int) {
	return fileDescriptor_44b18017c076fca5, []int{5}
}
...
func (*CratesSnapshot) Descriptor() ([]byte, []int) {
	return fileDescriptor_44b18017c076fca5, []int{6}
}
...
func init() { proto.RegisterFile("crates/crates.proto", fileDescriptor_44b18017c076fca5) }

var fileDescriptor_44b18017c076fca5 = []byte{
	...
	,
}
