...
// source: crates/api.amp.crates.proto
...
func (AssetFlags) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c122ff64a95e2c7f, []int{0}
}
...
func (CrateSchema) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c122ff64a95e2c7f, []int{1}
}
...
func (*AssetEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_c122ff64a95e2c7f, []int{2}
}
...
func (*BundleManifest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c122ff64a95e2c7f, []int{3}
}
...
func (*CrateInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c122ff64a95e2c7f, []int{4}
}
...
func (*CrateManifest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c122ff64a95e2c7f, []int{5}
}
...
func (*CratesSnapshot) Descriptor() ([]byte, []int) {
	return fileDescriptor_c122ff64a95e2c7f, []int{6}
}
...
func init() { proto.RegisterFile("crates/api.amp.crates.proto", fileDescriptor_c122ff64a95e2c7f) }

var fileDescriptor_c122ff64a95e2c7f = []byte{
	// 1050 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *KVEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Key) > 0 {
		i -= len(m.Key)
		copy(dAtA[i:], m.Key)
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.Key)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *AppVars) MarshalToSizedBuffer(dAtA []byte) (int, error) {
		...
		for iNdEx := len(m.Links) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintApiAmpCrates(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x2
			i--
	...
	if len(m.Settings) > 0 {
		for k := range m.Settings {
			...
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(v)))
			i--
			dAtA[i] = 0x12
			i -= len(k)
			copy(dAtA[i:], k)
			i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(k)))
			i--
			dAtA[i] = 0xa
			i = encodeVarintApiAmpCrates(dAtA, i, uint64(baseI-i))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xa2
	...
	if len(m.URLSchemes) > 0 {
		for iNdEx := len(m.URLSchemes) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.URLSchemes[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x92
	...
	if len(m.CratesSnapshotURL) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.CratesSnapshotURL)))
		i--
		dAtA[i] = 0x72
	}
	if len(m.AppHomeURL) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.AppHomeURL)))
		i--
		dAtA[i] = 0x62
	}
	if len(m.OrgHomeURL) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.OrgHomeURL)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.AppDesc) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.AppDesc)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.AppDomain) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.AppDomain)))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func (m *AssetEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ShortDesc) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.ShortDesc)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x82
	...
	if len(m.Tags) > 0 {
		i -= len(m.Tags)
		copy(dAtA[i:], m.Tags)
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.Tags)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xfa
	...
	if len(m.LocalURI) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.LocalURI)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf2
	...
	if len(m.Label) > 0 {
		i -= len(m.Label)
		copy(dAtA[i:], m.Label)
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.Label)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.EntryURI) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.EntryURI)))
		i--
		dAtA[i] = 0x12
	}
	if m.Flags != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.Flags))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *BundleManifest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BundleNameID) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.BundleNameID)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.BundleTitle) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.BundleTitle)))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func (m *CrateInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ApproxSize != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.ApproxSize))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xe0
	...
	if len(m.URL) > 0 {
		i -= len(m.URL)
		copy(dAtA[i:], m.URL)
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.URL)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xba
	...
	if len(m.HomeURL) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.HomeURL)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x92
	...
	if len(m.BuildID) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.BuildID)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xea
	...
	if m.BuildNumber != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.BuildNumber))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xd0
	...
	if m.MinorVersion != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.MinorVersion))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xc8
	...
	if m.MajorVersion != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.MajorVersion))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xc0
	...
	if m.TimeBuilt != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.TimeBuilt))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf8
	...
	if m.TimeCreated != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.TimeCreated))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf0
	...
	if len(m.CrateName) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.CrateName)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.PublisherName) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.PublisherName)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.CrateURI) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.CrateURI)))
		i--
		dAtA[i] = 0x22
	}
	if m.InstID != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.InstID))
		i--
		dAtA[i] = 0x10
	}
	if m.CrateSchema != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.CrateSchema))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *CrateManifest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IconBundleName) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.IconBundleName)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Info != nil {
...
func (m *CratesSnapshot) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DownloadURL) > 0 {
		...
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(len(m.DownloadURL)))
		i--
		dAtA[i] = 0x1a
	}
	if m.RevID != 0 {
		i = encodeVarintApiAmpCrates(dAtA, i, uint64(m.RevID))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintApiAmpCrates(dAtA []byte, offset int, v uint64) int {
	offset -= sovApiAmpCrates(v)
	base := offset
	for v >= 1<<7 {
...
func (m *KVEntry) Size() (n int) {
	...
	l = len(m.Key)
	if l > 0 {
		n += 1 + l + sovApiAmpCrates(uint64(l))
	}
	l = len(m.Value)
	if l > 0 {
		n += 1 + l + sovApiAmpCrates(uint64(l))
...
func (m *AppVars) Size() (n int) {
	...
	if len(m.AppDownloadURLs) > 0 {
		for k, v := range m.AppDownloadURLs {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovApiAmpCrates(uint64(len(k))) + 1 + len(v) + sovApiAmpCrates(uint64(len(v)))
			n += mapEntrySize + 2 + sovApiAmpCrates(uint64(mapEntrySize))
		}
	}
	if len(m.URLSchemes) > 0 {
		for _, s := range m.URLSchemes {
			l = len(s)
			n += 2 + l + sovApiAmpCrates(uint64(l))
		}
	}
	if len(m.Settings) > 0 {
...
func (m *AssetEntry) Size() (n int) {
	...
	_ = l
	if m.Flags != 0 {
		n += 1 + sovApiAmpCrates(uint64(m.Flags))
	}
	l = len(m.EntryURI)
	if l > 0 {
		n += 1 + l + sovApiAmpCrates(uint64(l))
...
func (m *CrateInfo) Size() (n int) {
	...
	_ = l
	if m.CrateSchema != 0 {
		n += 1 + sovApiAmpCrates(uint64(m.CrateSchema))
	}
	if m.InstID != 0 {
		n += 1 + sovApiAmpCrates(uint64(m.InstID))
	}
	l = len(m.CrateURI)
	if l > 0 {
		n += 1 + l + sovApiAmpCrates(uint64(l))
	...
	if m.TimeCreated != 0 {
		n += 2 + sovApiAmpCrates(uint64(m.TimeCreated))
	}
	if m.TimeBuilt != 0 {
		n += 2 + sovApiAmpCrates(uint64(m.TimeBuilt))
	}
	if m.MajorVersion != 0 {
		n += 2 + sovApiAmpCrates(uint64(m.MajorVersion))
	}
	if m.MinorVersion != 0 {
		n += 2 + sovApiAmpCrates(uint64(m.MinorVersion))
	}
	if m.BuildNumber != 0 {
		n += 2 + sovApiAmpCrates(uint64(m.BuildNumber))
	}
	l = len(m.BuildID)
	if l > 0 {
		n += 2 + l + sovApiAmpCrates(uint64(l))
	...
	if m.ApproxSize != 0 {
		n += 2 + sovApiAmpCrates(uint64(m.ApproxSize))
	}
	return n
}
...
func (m *CratesSnapshot) Size() (n int) {
	...
	_ = l
	if m.RevID != 0 {
		n += 1 + sovApiAmpCrates(uint64(m.RevID))
	}
	l = len(m.DownloadURL)
	if l > 0 {
		n += 1 + l + sovApiAmpCrates(uint64(l))
...
func sovApiAmpCrates(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozApiAmpCrates(x uint64) (n int) {
	return sovApiAmpCrates(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func valueToStringApiAmpCrates(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *KVEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowApiAmpCrates
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthApiAmpCrates
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipApiAmpCrates(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipApiAmpCrates(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowApiAmpCrates
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthApiAmpCrates
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupApiAmpCrates
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthApiAmpCrates        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowApiAmpCrates          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupApiAmpCrates = fmt.Errorf("proto: unexpected end of group")
)
