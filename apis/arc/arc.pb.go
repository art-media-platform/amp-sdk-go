...
func (m *CellLayout) Reset()      { *m = CellLayout{} }
func (*CellLayout) ProtoMessage() {}
func (*CellLayout) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4a0eb974cf54c93, []int{16}
}
func (m *CellLayout) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CellLayout) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CellLayout.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CellLayout) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CellLayout.Merge(m, src)
}
func (m *CellLayout) XXX_Size() int {
	return m.Size()
}
func (m *CellLayout) XXX_DiscardUnknown() {
	xxx_messageInfo_CellLayout.DiscardUnknown(m)
}

var xxx_messageInfo_CellLayout proto.InternalMessageInfo

// CellLabels is a standard attribute for a cell that can be listed or otherwise presented in a UI to the user.
...
func (m *CellLabels) Reset()      { *m = CellLabels{} }
func (*CellLabels) ProtoMessage() {}
func (*CellLabels) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4a0eb974cf54c93, []int{17}
}
func (m *CellLabels) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CellLabels) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CellLabels.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CellLabels) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CellLabels.Merge(m, src)
}
func (m *CellLabels) XXX_Size() int {
	return m.Size()
}
func (m *CellLabels) XXX_DiscardUnknown() {
	xxx_messageInfo_CellLabels.DiscardUnknown(m)
}

var xxx_messageInfo_CellLabels proto.InternalMessageInfo

func (m *CellLabels) GetTitle() string {
	if m != nil {
		return m.Title
	}
	return ""
...
func (m *CellLabels) GetSubtitle() string {
	if m != nil {
		return m.Subtitle
	}
	return ""
...
func (m *CellLabels) GetAbout() string {
	if m != nil {
		return m.About
	}
	return ""
...
func (m *CellLabels) GetLink() *AssetRef {
	if m != nil {
		return m.Link
	}
	return nil
...
func (m *CellLabels) GetCreated() int64 {
	if m != nil {
		return m.Created
	}
	return 0
...
func (m *CellLabels) GetModified() int64 {
	if m != nil {
		return m.Modified
	}
	return 0
...
type CellGlyphs struct {
	// List items and icons -- resolution appropriate for 10-20mm sq.
	Icon *AssetRef `protobuf:"bytes,1,opt,name=Icon,proto3" json:"Icon,omitempty"`
	// Small screens -- vicinity of 1200x720 resolution
	Res720 *AssetRef `protobuf:"bytes,2,opt,name=Res720,proto3" json:"Res720,omitempty"`
	// Tablets, laptops -- vicinity of 1920x1080
	Res1080 *AssetRef `protobuf:"bytes,3,opt,name=Res1080,proto3" json:"Res1080,omitempty"`
}

func (m *CellGlyphs) Reset()      { *m = CellGlyphs{} }
func (*CellGlyphs) ProtoMessage() {}
func (*CellGlyphs) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4a0eb974cf54c93, []int{18}
}
func (m *CellGlyphs) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CellGlyphs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CellGlyphs.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CellGlyphs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CellGlyphs.Merge(m, src)
}
func (m *CellGlyphs) XXX_Size() int {
	return m.Size()
}
func (m *CellGlyphs) XXX_DiscardUnknown() {
	xxx_messageInfo_CellGlyphs.DiscardUnknown(m)
}

var xxx_messageInfo_CellGlyphs proto.InternalMessageInfo

func (m *CellGlyphs) GetIcon() *AssetRef {
	if m != nil {
		return m.Icon
	}
	return nil
...
func (m *CellGlyphs) GetRes720() *AssetRef {
	if m != nil {
		return m.Res720
	}
	return nil
...
func (m *CellGlyphs) GetRes1080() *AssetRef {
	if m != nil {
		return m.Res1080
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CellLayout)(nil), "arc.CellLayout")
	proto.RegisterType((*CellLabels)(nil), "arc.CellLabels")
	proto.RegisterType((*CellGlyphs)(nil), "arc.CellGlyphs")
...
var fileDescriptor_e4a0eb974cf54c93 = []byte{
	...
	,
}
...
func (this *CellLayout) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CellLayout)
	if !ok {
		that2, ok := that.(CellLayout)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CellLabels) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CellLabels)
	if !ok {
		that2, ok := that.(CellLabels)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CellGlyphs) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CellGlyphs)
	if !ok {
		that2, ok := that.(CellGlyphs)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.Res720.Equal(that1.Res720) {
		return false
	}
	if !this.Res1080.Equal(that1.Res1080) {
		return false
	}
	return true
}
...
func (this *CellLayout) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&arc.CellLayout{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *CellLabels) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&arc.CellLabels{")
...
func (this *CellGlyphs) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&arc.CellGlyphs{")
	if this.Icon != nil {
		s = append(s, "Icon: "+fmt.Sprintf("%#v", this.Icon)+",\n")
	}
	if this.Res720 != nil {
		s = append(s, "Res720: "+fmt.Sprintf("%#v", this.Res720)+",\n")
	}
	if this.Res1080 != nil {
		s = append(s, "Res1080: "+fmt.Sprintf("%#v", this.Res1080)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *CellLayout) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CellLayout) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CellLayout) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CellLabels) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CellLabels) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CellLabels) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CellGlyphs) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CellGlyphs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CellGlyphs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Res1080 != nil {
		{
			size, err := m.Res1080.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.Res720 != nil {
		{
			size, err := m.Res720.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (this *CellLayout) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CellLayout{`,
		`}`,
	}, "")
	return s
}
func (this *CellLabels) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CellLabels{`,
...
func (this *CellGlyphs) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CellGlyphs{`,
		`Icon:` + strings.Replace(this.Icon.String(), "AssetRef", "AssetRef", 1) + `,`,
		`Res720:` + strings.Replace(this.Res720.String(), "AssetRef", "AssetRef", 1) + `,`,
		`Res1080:` + strings.Replace(this.Res1080.String(), "AssetRef", "AssetRef", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CellLayout) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CellLayout: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CellLayout: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *CellLabels) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CellLabels: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CellLabels: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 4:
			if wireType != 2 {
...
func (m *CellGlyphs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CellGlyphs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CellGlyphs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Res720", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Res720.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Res1080", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Res1080.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
