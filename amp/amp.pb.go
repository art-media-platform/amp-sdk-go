...
const (
	...
	//
	//- When an attr value is replaced ("edited"), the new EditID is function of the predecessor's EditID and the revision's home TxID..
	//- The purpose of an EditID is to safely determine its predecessor EditID, allowing a tree of revisions to be reconstructed.
	//- In effect, a sorted list of CellID / AttrID / SI / EditID form a CRDT -- EditID effectively is "height" described in https://peerlinks.io/protocol.html
	//- EditIDs are increasingly negative in time, causing the newest revisions to appear first when LSM sorted.
	//- Although EditIDs are naturally 24 bytes, the EditID is truncated to 16 bytes for storage efficiency since that's sufficiently unique.
	//
	//EditID := tag.ID{
	//0,                                 // reserved (truncated)
	//(newTxID[0] + prevEditID[0]) >> 1, // sort newest revisions first
	//newTxID[1] ^ prevEditID[1],
	//}
...
type Login struct {
	...
	Checkpoint *LoginCheckpoint `protobuf:"bytes,7,opt,name=Checkpoint,proto3" json:"Checkpoint,omitempty"`
}
...
type LoginCheckpoint struct {
	...
	AuthExpires int64  `protobuf:"varint,2,opt,name=AuthExpires,proto3" json:"AuthExpires,omitempty"`
}
...
func (m *LoginCheckpoint) GetAuthToken() string {
	if m != nil {
		return m.AuthToken
	}
	return ""
...
func (m *LoginCheckpoint) GetAuthExpires() int64 {
	if m != nil {
		return m.AuthExpires
	}
	return 0
}
...
var fileDescriptor_7e479d288f92766f = []byte{
	...
	,
}
...
func (this *LoginCheckpoint) Equal(that interface{}) bool {
	...
	if this.AuthExpires != that1.AuthExpires {
		return false
	}
	return true
}
...
func (this *LoginCheckpoint) GoString() string {
	...
	s = append(s, "AuthExpires: "+fmt.Sprintf("%#v", this.AuthExpires)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *LoginCheckpoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.AuthExpires != 0 {
		i = encodeVarintAmp(dAtA, i, uint64(m.AuthExpires))
		i--
		dAtA[i] = 0x10
	}
	if len(m.AuthToken) > 0 {
		...
		i = encodeVarintAmp(dAtA, i, uint64(len(m.AuthToken)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *LoginCheckpoint) Size() (n int) {
	...
	if m.AuthExpires != 0 {
		n += 1 + sovAmp(uint64(m.AuthExpires))
	}
	return n
}
...
func (this *LoginCheckpoint) String() string {
	...
	s := strings.Join([]string{`&LoginCheckpoint{`,
		...
		`AuthExpires:` + fmt.Sprintf("%v", this.AuthExpires) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *LoginCheckpoint) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuthExpires", wireType)
			}
			m.AuthExpires = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AuthExpires |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
