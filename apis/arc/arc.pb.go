...
type AttrDomain int32

const (
	AttrDomain_Common AttrDomain = 0
	AttrDomain_Pinned AttrDomain = 1
)

var AttrDomain_name = map[int32]string{
	0: "AttrDomain_Common",
	1: "AttrDomain_Pinned",
}

var AttrDomain_value = map[string]int32{
	"AttrDomain_Common": 0,
	"AttrDomain_Pinned": 1,
}

func (AttrDomain) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e4a0eb974cf54c93, []int{4}
}

type CellDomain int32

const (
	CellDomain_ParentCell CellDomain = 0
	CellDomain_ChildCell  CellDomain = 1
)

var CellDomain_name = map[int32]string{
	0: "CellDomain_ParentCell",
	1: "CellDomain_ChildCell",
}

var CellDomain_value = map[string]int32{
	"CellDomain_ParentCell": 0,
	"CellDomain_ChildCell":  1,
}

func (CellDomain) EnumDescriptor() ([]byte, []int) {
...
type CellTxPb struct {
	...
	CellSpec   uint32        `protobuf:"varint,2,opt,name=CellSpec,proto3" json:"CellSpec,omitempty"`
...
func (m *CellTxPb) GetCellSpec() uint32 {
	if m != nil {
		return m.CellSpec
	}
	return 0
...
// A CellSpec fully describes this cell's attrs as a child and when this cell is pinned.
// Two cells with a matching CellSpec descriptor are the same "type" of cell.
type CellSpec struct {
	...
	//
	// e.g. "(CellLabels,ArtistTour)(AssetRef:promoVideo,[UTC16]TourStop:summer-tour)"
	DefID uint32 `protobuf:"varint,1,opt,name=DefID,proto3" json:"DefID,omitempty"`
	// A sequence of AttrSpecs (addr symbol descriptors) that are this Cell has as both a child and parent.
...
func (m *CellLabels) GetGlyph() *AssetRef {
	if m != nil {
		return m.Glyph
	}
	return nil
...
func (m *CellLabels) GetGlyphLarge() *AssetRef {
	if m != nil {
		return m.GlyphLarge
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("arc.AttrDomain", AttrDomain_name, AttrDomain_value)
	proto.RegisterEnum("arc.CellDomain", CellDomain_name, CellDomain_value)
...
var fileDescriptor_e4a0eb974cf54c93 = []byte{
	...
	,
}
...
func (x AttrDomain) String() string {
	s, ok := AttrDomain_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
}
func (x CellDomain) String() string {
	s, ok := CellDomain_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *CellTxPb) Equal(that interface{}) bool {
	...
	if this.CellSpec != that1.CellSpec {
		return false
	}
...
func (this *CellTxPb) GoString() string {
	...
	s = append(s, "CellSpec: "+fmt.Sprintf("%#v", this.CellSpec)+",\n")
...
func (m *CellTxPb) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CellSpec != 0 {
		i = encodeVarintArc(dAtA, i, uint64(m.CellSpec))
		i--
		dAtA[i] = 0x10
	}
	if m.Op != 0 {
...
func (this *CellTxPb) String() string {
	...
	s := strings.Join([]string{`&CellTxPb{`,
		...
		`CellSpec:` + fmt.Sprintf("%v", this.CellSpec) + `,`,
...
func (m *CellTxPb) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CellSpec", wireType)
			}
			m.CellSpec = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CellSpec |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
